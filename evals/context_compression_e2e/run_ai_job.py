...
def collect_run_diagnostics(stdout: str, stderr: str) -> dict[str, object]:
    ...
    return {
        ...
        "socket_timeout_count": stderr.count("socket.timeout: timed out"),
        "http_timeout_count": stderr.count("timed out"),
        "final_task_user_message_count": session_text.count("现在开始真正修改代码"),
